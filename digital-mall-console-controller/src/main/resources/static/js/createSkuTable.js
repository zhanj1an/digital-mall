...
//			});
//			
			SKUTableDom += "<table id='skuValue' class='skuTable'><tr>";
			//创建表头
...
//				});
				...
				SKUTableDom += '<tr propvalids=\''+propvalids+'\' propids=\''+propIdArr.toString()+'\' propvalnames=\''+propvalnameArr.join(";")+'\'  propnames=\''+propNameArr.join(";")+'\' class="sku_table_tr">'+currRowDoms+'<td><input type="text" name="price" class="setting_sku_price" value="'+alreadySetSkuPrice+'"/></td><td><input type="text" name="stock" class="setting_sku_stock" value="'+alreadySetSkuStock+'"/></td></tr>';
				SKUTableDom += '<input type="hidden" name="attrValue" value="' + propvalnameArr.join(",") + '">';
			}
			SKUTableDom += '<input type="hidden" name="attrName" value="' + propNameArr.join(",") + '">';
			SKUTableDom += "</table>";
		}
